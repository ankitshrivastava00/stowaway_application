...
class ConfirmActivity extends StatefulWidget {
  @override
  _ConfirmActivityState createState() => _ConfirmActivityState();
}

class _ConfirmActivityState extends State<ConfirmActivity> {
